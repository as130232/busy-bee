...
export function LoginPage() {
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-3 px-6 pb-[env(safe-area-inset-bottom)]">
      <div className="mb-2 rounded-2xl bg-accent/10 p-4 shadow-[0_0_80px_-16px] shadow-accent/40">
        <BrandMark className="size-10" />
      </div>
      <h1 className="text-2xl font-semibold tracking-tight">Busy Bee</h1>
      <p className="text-sm text-muted">開會錄音 → AI 生成 PRD / Tech Spec</p>
      <button
        type="button"
